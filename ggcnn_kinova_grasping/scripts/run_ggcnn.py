...
# Load the Network.
MODEL_FILE = '/home/fei/ggcnn-master/data/networks/190403_1115__ggcnn_9_5_3__32_16_8/epoch_100_model.hdf5'
# MODEL_FILE = '/home/fei/ggcnn-master/data/networks/epoch_08_model.hdf5'
...
depth_pub1 = rospy.Publisher('ggcnn/img/depth1', Image, queue_size=1)
depth_pub2 = rospy.Publisher('ggcnn/img/depth2', Image, queue_size=1)
...
# points_pub = rospy.Publisher('ggcnn/img/points_out', Image, queue_size=1)
...
def depth_callback(depth_message):
    ...
    with TimeIt('Inpaint'):
        ...
        # print("depth_scale")
        # print(depth_scale,depth_crop.min())
        depth_crop = depth_crop.astype(np.float32)/depth_scale  # Has to be float32, 64 not supported.
        depth_crop = cv2.inpaint(depth_crop, mask, 1, cv2.INPAINT_NS)

        # Back to original size and value range.
        depth_crop = depth_crop[1:-1, 1:-1]
        depth_crop = depth_crop * depth_scale * 0.000125
        # print(depth_crop,depth_crop.max(),depth_crop.min())
    ...
    with TimeIt('Inference'):
        ...
        # depth_pub1.publish(bridge.cv2_to_imgmsg(depth_crop - depth_crop.mean()))
    ...
    with TimeIt('Control'):
        ...
        # print('max_pixel')
        # print(max_pixel[0],max_pixel[1])
        point_depth = depth[max_pixel[0], max_pixel[1]] * 0.000125
        # print(point_depth)
    ...
    with TimeIt('Publish'):
        ...
        # points_pub.publish(bridge.cv2_to_imgmsg(points_out, 'bgr8'))
